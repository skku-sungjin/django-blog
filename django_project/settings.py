...
#SECRET_KEY = '$h@b!0edf^79*+nkwdr-v$m)&3*e%+gh^tw*huv*#zxzqau)6f'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DEBUG_VALUE') == 'True')

ALLOWED_HOSTS = ['skku7714djangoapp.herokuapp.com']
...
EMAIL_PORT  = 587
EMAIL_USE_TLS = True
# these below variables are in the ~/.zshrc
...
AWS_S3_REGION_NAME = "ap-northeast-2" # added to remove error about : AWS4-HMAC-SHA256
